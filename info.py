...
API_ID = int(environ.get('API_ID', '24278807'))
API_HASH = environ.get('API_HASH', 'd29090a8b61d42a2b414257f7256c630')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', ' 5055814800').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002390827114'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002534493158').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002477906268') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002653702251')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', ' -1002461134824').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://athulvasu246:v4l67EoAbp7fbe8L@cluster0.7lxponw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+d-P-WDjrmmY4ODI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+mxI5zUB0quo0MWJl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+0w9c5-Mj3FkxMTA1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Shumbidi')
